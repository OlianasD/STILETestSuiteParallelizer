...
public class UpdateSubproject1StatusReleaseTest {
	...
	@Test
	public void testMantisBTupdateSubproject1StatusRelease() throws Exception {
		...
		assertEquals("release", driver.findElement(By.xpath("/html/body/table[3]/tbody/tr[4]/td[2]")).getText());

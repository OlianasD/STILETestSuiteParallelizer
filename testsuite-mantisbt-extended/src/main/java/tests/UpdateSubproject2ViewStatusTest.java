...
public class UpdateSubproject2ViewStatusTest {
	...
	@Test
	public void testMantisBTupdateSubproject2ViewStatus() throws Exception {
		...
		assertEquals("private", driver.findElement(By.xpath("/html/body/table[3]/tbody/tr[5]/td[4]")).getText());

...
public class UpdateIssuePriorityTest {
	...
	public void testMantisBTUpdateIssuePriority(String port, String host) throws Exception {
		for(int i=0; i<data.length; i++) {
			...
			driver.findElement(By.linkText("View Issues")).click();
			assertEquals("low",
					driver.findElement(By.xpath(".//*[@id='buglist']/tbody/tr["+data[i][0]+"]/td[3]/img")).getAttribute("title"));

...
public class UpdateUser2AccessLevelAdministratorTest {
	...
	public void testMantisBTUpdateUser1AccessLevelReporter(String port, String host) throws Exception {
		//for(int i=0; i<data.length; i++) {
			...
			assertEquals("administrator", new Select(driver.findElement(By.name("access_level"))).getFirstSelectedOption().getText());

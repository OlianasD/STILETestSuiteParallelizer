...
public class UpdateSubproject1DescriptionTest {
	...
	@Test
	public void testMantisBTupdateSubproject1Description() throws Exception {
		...
		assertEquals("descr", driver.findElement(By.xpath("/html/body/table[3]/tbody/tr[4]/td[5]")).getText());

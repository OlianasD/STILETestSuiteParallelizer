...
public class UpdateSubproject1ViewStatusTest {
	...
	@Test
	public void testMantisBTupdateSubproject1ViewStatus() throws Exception {
		...
		assertEquals("private", driver.findElement(By.xpath("/html/body/table[3]/tbody/tr[4]/td[4]")).getText());

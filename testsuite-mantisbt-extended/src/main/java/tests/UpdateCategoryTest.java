...
public class UpdateCategoryTest {
	...
	public void testMantisBTUpdateCategory(String port, String host) throws Exception {
		for(int i=0; i<data.length; i++) {
			...
			driver.findElement(By.name("name")).sendKeys("CategoryNEW");
			driver.findElement(By.cssSelector("input.button")).click();
			driver.findElement(By.linkText("Proceed")).click();
			assertEquals("CategoryNEW",

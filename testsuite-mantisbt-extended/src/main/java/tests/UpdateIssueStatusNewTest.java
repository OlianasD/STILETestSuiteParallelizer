...
public class UpdateIssueStatusNewTest {
	...
	public void testMantisBTUpdateIssueStatusNew(String port, String host) throws Exception {
		for(int i=0; i<data.length; i++) {
			...
			new Select(driver.findElement(By.name("status"))).selectByVisibleText("new");
			driver.findElement(By.cssSelector("input.button")).click();
			driver.findElement(By.linkText("View Issues")).click();
			assertEquals("new (administrator)",

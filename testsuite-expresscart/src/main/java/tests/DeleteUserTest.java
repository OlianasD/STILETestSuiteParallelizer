...
public class DeleteUserTest {
	...
	public void testExpressCartDeleteUser(String port, String host) throws Exception {
		for(int i=0; i<40; i++) {
			...
			driver.findElement(By.xpath("//*[@id=\"container\"]/div/nav/div/ul[1]/li[6]/a[1]")).click();
			if(i<39) 
				assertFalse(driver.findElement(By.xpath("//*[@id=\"container\"]/div/main/div[2]/ul/li[3]")).getText().contains("test00"+i+"@test.com"));
			else
				assertFalse(driver.findElement(By.tagName("body")).getText().contains("test00"+i+"@test.com"));

...
public class AddDiscountCodeAmountTest {
	...
	public void testExpressCartAddDiscountCodeAmount(String port, String host) throws Exception {
		//int i = 0;
		for(int i=0; i<29; i++) {
			String code;
			if(i<10)
			...
			/*assertEquals("Code:  discount00"+i, driver.findElement(By.xpath("//*[@id=\"container\"]/div/main/div/ul/li["+(i+5)+"]/div/div[1]/span")).getText());
			assertEquals("Type:  amount", driver.findElement(By.xpath("//*[@id=\"container\"]/div/main/div/ul/li["+(i+5)+"]/div/div[2]/span")).getText());
			assertEquals("Status: Running", driver.findElement(By.xpath("//*[@id=\"container\"]/div/main/div/ul/li["+(i+5)+"]/div/div[3]/span")).getText());*/

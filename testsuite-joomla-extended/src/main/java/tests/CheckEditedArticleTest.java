...
public class CheckEditedArticleTest {
	...
	@Test
	public void testJoomlaCheckEditedArticle() throws Exception {
		...
		for(int i=19; i>=0; i--) {
			...
			String body = "This is the body of the first article for testing the platformEDITED"+(19-i);

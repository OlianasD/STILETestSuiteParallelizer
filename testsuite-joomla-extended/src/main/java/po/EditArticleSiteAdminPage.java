...
public class EditArticleSiteAdminPage extends PageObject {
	...
	@FindBy(xpath = "//*[@id=\"general\"]/div/div[2]/fieldset/div[5]/div[2]/joomla-field-fancy-select/div/div[1]/input")
	protected WebElement tagSelect;
	...
	public EditArticleSiteAdminPage selectTag(String tag) {
